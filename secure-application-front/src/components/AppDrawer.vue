<template>
  <v-navigation-drawer
    ...
    :width="drawWidth"
  >
    <v-toolbar color="primary darken-1" dark></v-toolbar>
    ...
    return {
      ...
      menus: [
        ...
        { header: "Other" },
        {
          ...
          icon: "view_compact",
          items: [
            { name: "About us", title: "About us", component: "AboutUs" },
            { name: "About project", title: "About project", component: "AboutProject" }
          ]
        }
      ],
      scrollSettings: {
